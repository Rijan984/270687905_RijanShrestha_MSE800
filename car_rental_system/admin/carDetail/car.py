...
class addCarDetails:
    def __init__(self, model, year, mileage, availability, min_rent_period, max_rent_period, bookingStatus, admin_id):
        self.model = model
        self.year = year
    ...
    def addCar(self):
        add_car(self.model, self.year, self.mileage, self.availability, self.min_rent_period, self.max_rent_period, self.bookingStatus, self.admin_id) #adding data to database        
...
def carDetails(data):
    ...
    car = addCarDetails(model, year, mileage, availability, min_rent_period, max_rent_period, bookingStatus, admin_id)
